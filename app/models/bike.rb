class Bike < ApplicationRecord
  ...
  # validates_format_of :batteryNo, with: '', message: "Please enter battery number in the following format: BBM(B)N********"
  # validates_format_of :chargerNo, with: '', message: "Please enter motor number in the following format: BBM(M)N********"
end
